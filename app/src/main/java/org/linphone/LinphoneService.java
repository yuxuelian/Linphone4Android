...
public final class LinphoneService extends Service {
	...
	public final static String CHANNEL_ID = "Linphone";
	...
	*/
	...
	public void onCreate() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			NotificationChannel notificationChannel = new NotificationChannel(LinphoneService.CHANNEL_ID, "通话", NotificationManager.IMPORTANCE_LOW);
